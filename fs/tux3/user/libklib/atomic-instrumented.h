...
#ifndef LIBKLIB_ATOMIC_INSTRUMENTED_H
#define LIBKLIB_ATOMIC_INSTRUMENTED_H

#include <libklib/bitops.h>	/* for BITS_PER_LONG */
#include <libklib/build_bug.h>

#define kasan_check_read(v, s)	do {} while (0)
#define kasan_check_write(v, s)	do {} while (0)

/* BUILD_BUG() doesn't work without optimizer. */
#ifdef __OPTIMIZE__
#define BUILD_BUG_IF_OPTIMIZE()	BUILD_BUG()
#else
#define BUILD_BUG_IF_OPTIMIZE()	BUG()
#endif
...
#endif /* LIBKLIB_ATOMIC_INSTRUMENTED_H */
